...
// 2B08
if (info->currentFileOffset >= info->dataOff + info->streamDataByte)
return 0;
int ret = (BufferSoFar - OffsetSoFar - firstSampleoffset) / bytesPerFrame;
...
int Atrac::Analyze() {
	...
	// Even if the RIF size is too low, it may simply be incorrect.  This works on real firmware.
